                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de unidads</h5>
                        </div>
                        <div class="card-body">
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('unidad.search');
            ...
            axios.get(ruta, {
                    ...
                    // Cuando la petición indica que todo está OK
        ...
        // Abrir el modal para crear una nueva unidad
        function modalCrear() {
        ...
        // Abrir el modal para editar una unidad existente
        function modalEditar(id) {
            const ruta = route('unidad.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('unidad.update', [id]);
        ...
        // Confirmar y eliminar una unidad existente
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('unidad.destroy', [id]);
