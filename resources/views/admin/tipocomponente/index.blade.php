...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #09467F">
    ...
    <!-- Dropdown para usuario y cerrar sesión -->
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de tipocomponente</h5>
                        </div>
                        <div class="card-body">
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('tipocomponente.search');
        ...
        function modalCrear() {
            const ruta = route("tipocomponente.create");
            ...
            axios.get(ruta)
                .then(function(respuesta) {
                    ...
                    toastr.error('Error al cargar el formulario de creación');
                })
        }

        // Función para guardar un nuevo registro
        function guardar() {
            const ruta = route('tipocomponente.store');
        ...
        function modalEditar(id) {
            const ruta = route('tipocomponente.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('tipocomponente.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('tipocomponente.destroy', [id]);
